...
{
    public class AllProjectsUserCommand : RemoteStorageUserCommandBase
    {
        private readonly IMessageWriter _messageWriter;
        private readonly CommandParameters _parameters;
        
        public AllProjectsUserCommand(IHttpClientFactory httpClientFactory, JwtAuthorizeProvider authorizeProvider, IMessageWriter messageWriter, CommandParameters parameters) 
            : base("projects", HttpMethod.Get, httpClientFactory, authorizeProvider)
        {
        ...
        protected override void Execute(HttpStatusCode statusCode, string json)
        {
            ...
            {
                var answer = JsonConvert.DeserializeObject<PagedDataResponse<Project>>(json);
            ...
            {
                _messageWriter.WriteMessage($"Success code: {statusCode}");
            }
        }
    }
}